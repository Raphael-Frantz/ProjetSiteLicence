<?php
// @need etudiant l'étudiant à modifier
?>
<section class="mytitle text-center bg-light">
  <div class="container">
    <h2 class="mb-5">Modifier un étudiant</h2>
    <p class="lead mb-0">Modifier les données d'un étudiant.</p>
  </div>
</section>
...
<section class="mysection mb-2">
  <div class="container">
    ...
    <form action="<?php echo WEB_PATH; ?>etudiants/modifier.php" method="post">
