<?php
// @need user l'enseignant à modifier
?>
<section class="mytitle text-center bg-light">
  <div class="container">
    <h2 class="mb-5">Modifier un enseignant</h2>
    <p class="lead mb-0">Modifier les données d'un enseignant.</p>
  </div>
</section>
...
<section class="mysection mb-2">
  <div class="container">
    ...
    <form action="<?php echo WEB_PATH; ?>users/modifier.php" method="post">
