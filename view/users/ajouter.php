...
<section class="mytitle text-center bg-light">
  <div class="container">
    <h2 class="mb-5">Créer un enseignant</h2>
    <p class="lead mb-0">Saisissez les informations du nouvel enseignant.</p>
  </div>
</section>
...
<section class="mysection mb-2">
  <div class="container">
    ...
    <form action="<?php echo WEB_PATH; ?>users/ajouter.php" method="post">
