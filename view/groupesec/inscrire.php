...
<section class="mytitle text-center bg-light">
  <div class="container">
    ...
    <p class="lead mb-0">
      Sélectionnez les étudiants dans la liste pour les inscrire dans le groupe 
      <span class="badge"><?php echo $data['groupeObj']; ?></span> de <span class="badge"><?php echo $data['EC']->getCode(); ?></span>.
    </p>
  </div>
</section>
...
<form class="form-inline justify-content-center mt-2">
  <div class="form-group mb-2">
     <a id="listeLink" data-toggle='tooltip' data-placement='top' title='Retourner à la liste des étudiants' class="btn btn-outline-primary mr-2" href="<?php echo WEB_PATH; ?>groupesec/etudiants.php">Retour</a>
  </div>
</form>
