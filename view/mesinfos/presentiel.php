...
<section class="mytitle text-center bg-light">
  <div class="container">
    <h2 class="mb-5">Mon présentiel</h2>
    <p class="lead mb-0">Retrouvez ici vos justificatifs d'absence et votre présentiel pour tous les EC.</p>
    <div class="alert alert-danger lead text-center mt-2" role="alert">
      Si vous avez une absence injustifiée et que vous avez un justificatif, merci de contacter le responsable de la formation ou votre tuteur.
      Si vous constatez des problèmes sur le présentiel dans un EC, contactez le responsable de l'EC ou l'intervenant.
    </div> 
  </div>
</section>
...
<section>
  <div class="container">
    <h3 class="mb-4">Mes justificatifs d'absence</h3>
...
<section class="bg-light">
  <div class="container mb-0">
    <h3 class="mb-4">Mon présentiel</h3>
<?php
