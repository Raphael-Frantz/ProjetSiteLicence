...
<section class="mytitle text-center bg-light">
  <div class="container">
    <h2 class="mb-5">Suppression d'un diplôme</h2>
    <p class="lead mb-0">Vous êtes sur le point de supprimer le diplôme <span class="badge lead"><?php echo $data['diplome']; ?></span>.</p>
  </div>
</section>

<section class="text-center bg-light">
  <div class="container">
    <form action="<?php echo WEB_PATH; ?>diplomes/supprimer.php" method="post">
